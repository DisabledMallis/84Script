...
public class EFScriptParser extends Parser {
	...
	public final ScriptContext script() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << OPEN_BRACKET) | (1L << OPEN_CURLEY) | (1L << END_STMT) | (1L << VAR) | (1L << IF) | (1L << WHILE) | (1L << RETURN) | (1L << IDENTIFIER) | (1L << NUMBER) | (1L << TEXT))) != 0)) {
					{
					{
					setState(46);
					statement();
	...
	public static class ExpressionContext extends ParserRuleContext {
		...
		public TerminalNode TEXT() { return getToken(EFScriptParser.TEXT, 0); }
