...
public interface EFScriptVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link EFScriptParser#func_params}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunc_params(EFScriptParser.Func_paramsContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link EFScriptParser#ti_basic_stmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
